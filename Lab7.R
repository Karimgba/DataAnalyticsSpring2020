...
install.packages("GPArotation")   #had to install this package first
...
#display the solution output, used .txt file to understand solution
solution
...
#################################### lab2_fa4 ####################################
data(epi)    #had trouble running this example
